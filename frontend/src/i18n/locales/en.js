...
export const en = {
    ...
    helpTabNameDesc: 'Rename from the tab menu or right-click. The name shows up on the tab bar and in lists, so short names pay off on tabs you use often.',
    ...
    helpSecTools: 'Installing tools',
    helpToolsTerm: 'Put what you want on a machine',
    helpToolsDesc: 'The 📦 button on a host card (or on this server) opens the install list. tmux and itl ship as the built-in entries; everything else you add yourself — this app does not decide what belongs on your machines.',
    helpToolsCheckTerm: 'It does not run the install for you',
    helpToolsCheckDesc: 'It opens a terminal on that machine and types the command; you press Enter. That way sudo prompts, progress output and Ctrl-C all behave normally, and you read what will run before it runs.',
    helpStatusDotTerm: 'The dot on a tab',
    helpStatusDotDesc: 'The agent in that tab is working, or waiting for you to confirm something. Nothing is drawn when it is idle.',
  ...
  terminalInputCollapse: 'Collapse',
    showTerminalScrollbarHint: 'Drag the scrollbar on the right to view earlier output.',
    terminalScrollUnavailable: 'Scroll history is unavailable',
    ...
    hostNameFieldHint: 'The name you will see in the list. It seeds the tab name.',
    ...
    windowsUnsupported: 'This host looks like Windows — persistent sessions, file paste and tool installs all assume a POSIX shell. Registering the SSH server inside WSL works as usual.',
    ...
    guideStep3: 'Put your tools on a machine: the 📦 button on a host card opens the install list and types the command into a terminal there.',
    ...
    muxHintTmux: 'Remote tmux keeps your session alive when you disconnect. If tmux is missing the host still opens — as a plain shell that does not persist.',
    muxHintNone: 'A plain SSH shell. Closing the tab or losing the connection ends whatever is running.',
    ...
    defaultMultiplexer: 'Session multiplexer',
    defaultMultiplexerHint: 'What every terminal you open from now on runs — here and on hosts. Only one of them needs to be installed.',
    ...
    restartSessionHint: 'Ends what is running and opens a fresh shell',
    ...
    restartSessionAtPath: 'Restart at path…',
    restartSessionAtPathHint: 'Opens a fresh shell in the folder you pick',
    restartSessionAtPathConfirm: 'This reopens the session at this path. Every process running in the current session is terminated.',
    ...
    workspaceConflictTitle: 'Workspace changed elsewhere',
    workspaceConflictMessage: 'Another device changed the tab layout. Choose which layout to keep before ending any sessions.',
    keepThisDevice: 'Keep this device',
    useServerWorkspace: 'Use server state',
    ...
    hostsUnreachable: 'Could not check {names} — tap to retry',
    remoteAgent: 'Remote',
    remoteConnected: 'Connected — this host is reporting its own state',
    remoteInstalledIdle: 'Installed — not connected yet',
    remoteNotInstalled: 'Not connected — this host’s terminals show “?” and cannot receive commands',
    remoteInstall: 'Install remote',
    remoteHint: 'Installing lets this host connect on its own from behind NAT, survive reboots, and hold a credential scoped to itself.',
    ...
    toolUnknown: 'Unknown',
    toolUnknownHint: 'Could not check — this does not mean it is missing.',
    toolInstall: 'Install in a terminal',
    copyCommand: 'Copy command',
    toolAdd: 'Add your own',
    toolName: 'Name',
    toolInstallCommand: 'Install command',
    toolCheckCommand: 'Check command (optional)',
    toolCheckHint: 'Prefer `command -v <name>` — it never runs the program, so the check cannot hang.',
    ...
    launchDefault: 'Default',
    launchMultiplexer: 'Terminal',
    launchShell: 'Shell',
    newFolder: 'New folder',
    newFolderName: 'New folder name',
    newFolderBadName: 'A folder name cannot contain /',
    newFolderFailed: 'Could not create the folder',
    create: 'Create',
    moreActions: 'More',
    openTerminalSamePath: 'New terminal at this path',
    openTerminalHereHint: 'Opens another one here and keeps this one running',
